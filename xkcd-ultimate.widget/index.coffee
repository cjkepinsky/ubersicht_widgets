...
style: """
  ...
  widget-align = right			// Align contents left or right
  ...
  img
    max-height: 70vh		// allow the img to use up at most 85% of the desktop's height
...
update: (output, domEl) -> 
  try
    ...
    content = 
      """
	  <div id="xkcd-title"><a href="#{xkcd.img}">#{xkcd.title}</a></div>
